...
pub fn module() -> Module {
    ...
    pdf.define_func::<table_summary>().gated(Feature::A11yExtras);
    pdf.define_func::<header_cell>().gated(Feature::A11yExtras);
    pdf.define_func::<data_cell>().gated(Feature::A11yExtras);
